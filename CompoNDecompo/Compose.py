...
if __name__ == "__main__":
    ...
    from Alphabets import HEAD,TAIL,BODY,\
                      ...
                      NUMBERS
    decom = ['ㅈ', 'ㅔ', '', 'ㄱ', 'ㅏ', '', ' ', 'ㅈ', 'ㅣ', 'ㄱ', 'ㅈ', 'ㅓ', 'ㅂ', ' ', 'ㅁ', 'ㅏ', 'ㄴ', 'ㄷ', 'ㅡ', 'ㄴ', ' ', 'ㅍ', 'ㅐ', '', 'ㅋ', 'ㅣ', '', 'ㅈ', 'ㅣ', '', '2', ' ', 'ㅇ', 'ㅣ', 'ㅂ', 'ㄴ', 'ㅣ', '', 'ㄷ', 'ㅏ', '', '.', ' ', 'ㅂ', 'ㅗ', ' ㄴ', ' ', 'ㅍ', 'ㅐ', '', 'ㅋ', 'ㅐ', '', 'ㅈ', 'ㅣ', '', 'ㄴ', 'ㅡ', 'ㄴ', ' ', 'ㅁ', 'ㅜ', 'ㄴ', 'ㅈ', 'ㅏ', 'ㅇ', 'ㅇ', 'ㅡ', 'ㄹ', ' ', 'ㅈ', 'ㅓ', 'ㅁ', 'ㅈ', 'ㅏ', '', 'ㄹ', 'ㅗ', '', ' ', 'ㅂ', 'ㅕ', 'ㄴ', 'ㅎ', 'ㅘ', 'ㄴ', 'ㅎ', 'ㅏ', '', 'ㄴ', 'ㅡ', 'ㄴ', ' ', 'ㄱ', 'ㅘ', '', 'ㅈ', 'ㅓ', 'ㅇ', 'ㅇ', 'ㅢ', '', ' ', 'ㅇ', 'ㅣ', 'ㄹ', 'ㅎ', 'ㅘ', 'ㄴ', 'ㅇ', 'ㅡ', '', 'ㄹ', 'ㅗ', '', ' ', 'ㄱ', 'ㅐ', '', 'ㅂ', 'ㅏ', 'ㄹ', 'ㄷ', 'ㅚ', 'ㄴ', ' ', 'ㅍ', 'ㅐ', '', 'ㅋ', 'ㅣ', '', 'ㅈ', 'ㅣ', '', 'ㅇ', 'ㅣ', 'ㅂ', 'ㄴ', 'ㅣ', '', 'ㄷ', 'ㅏ', '', '.']
    l = []
    for c in decom:
        if(c==''): continue
        l.append(c)
